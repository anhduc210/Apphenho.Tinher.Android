...
public class Messages_Fragment extends Fragment {
    ...
    public static Messages_Fragment newInstanceMessages() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapterMessages=new AdapterMessages(list);
        a = view.findViewById(R.id.rvMessageItem);
//        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(
//                getContext(), 2, RecyclerView.VERTICAL, false);
        RecyclerView.LayoutManager layoutManager=new LinearLayoutManager(getContext(), RecyclerView.VERTICAL, false);
        a.setLayoutManager(layoutManager);
        a.setAdapter(adapterMessages);
